...
nvcc -O3 -o ${CTR_BUILD_DIR}/main main2.cu ${CTR_BUILD_DIR}/ufbx.o ${CTR_BUILD_DIR}/fbx_loader.o ${CTR_BUILD_DIR}/obj_loader.o ${CTR_BUILD_DIR}/tgaimage.o ${CTR_BUILD_DIR}/args.o # ${CTR_BUILD_DIR}/cpu_rasterizer.o
